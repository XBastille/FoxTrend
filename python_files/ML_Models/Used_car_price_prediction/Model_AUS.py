...
class VehiclePricePredictor:
    def __init__(self):
        self.model = joblib.load('python_files/ML_Models/Used_car_price_prediction/model_aus/model.joblib')
        self.scaler = joblib.load('python_files/ML_Models/Used_car_price_prediction/model_aus/scaler.joblib')
        self.brand_encoder = joblib.load('python_files/ML_Models/Used_car_price_prediction/model_aus/Brand_encoder.joblib')
