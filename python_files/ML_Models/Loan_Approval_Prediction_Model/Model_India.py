...
class LoanApprovalModel:
    def __init__(self):
        self.model = joblib.load('python_files/ML_Models/Loan_Approval_Prediction_Model/model_loan/model.joblib')
        self.scaler = joblib.load('python_files/ML_Models/Loan_Approval_Prediction_Model/model_loan/scaler.joblib')
        self.feature_names = joblib.load('python_files/ML_Models/Loan_Approval_Prediction_Model/model_loan/feature_names.joblib')
