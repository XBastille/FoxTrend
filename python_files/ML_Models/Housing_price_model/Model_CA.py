...
class HousingPriceModel:
    def __init__(self):
        self.model = joblib.load('python_files/ML_Models/Housing_price_model/model/model.joblib')
        self.scaler = joblib.load('python_files/ML_Models/Housing_price_model/model/scaler.joblib')
        self.le_city = joblib.load('python_files/ML_Models/Housing_price_model/model/le_city.joblib')
        self.le_province = joblib.load('python_files/ML_Models/Housing_price_model/model/le_province.joblib')
