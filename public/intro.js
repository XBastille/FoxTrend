document.querySelector(".StockButton").addEventListener("click" , function(){
  ...
  document.addEventListener('scroll' , function(){
    ...
    const boxposi = codebox.getBoundingClientRect().top;
    const windowHeight = window.innerHeight;
  
    if(boxposi < windowHeight && !codebox.classList.add('visible')){
  ...
  document.addEventListener('scroll' , function(){
    ...
    const downposi = Download.getBoundingClientRect().top;
    const windowHeight = window.innerHeight;
  
    if(downposi < windowHeight && !Download.classList.add('visible')){
        Download.classList.add('visible');
    }
  })

  document.addEventListener('scroll' , function(){
    const GitStars = document.querySelector('.gitstars');
    const gitposi = GitStars.getBoundingClientRect().top;
    const windowHeight = window.innerHeight;
  
    if(gitposi < windowHeight && !GitStars.classList.add('visible')){
        GitStars.classList.add('visible');
    }
  })

  document.addEventListener('scroll' , function(){
    const Small = document.querySelector('.smallheading');
    const smallposi = Small.getBoundingClientRect().top;
    const windowHeight = window.innerHeight;
  
    if(smallposi < windowHeight && !Small.classList.add('visible')){
        Small.classList.add('visible');
    }
  })

  document.addEventListener('scroll' , function(){
    const Big = document.querySelector('.bigheading');
    const bigposi = Big.getBoundingClientRect().top;
    const windowHeight = window.innerHeight;
  
    if(bigposi < windowHeight && !Big.classList.add('visible')){
  ...
  document.addEventListener('scroll', () => {
    ...
    [textLeft, textRight].forEach((box) => {
  ...
  function toggleFAQ(iconElement) {
    const faqElement = iconElement.closest(".faq");
