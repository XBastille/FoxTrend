...
class UsedCarPricePredictor:
    def __init__(self):
        self.model = joblib.load('model_uk/model.joblib')
        self.scaler = joblib.load('model_uk/scaler.joblib')
        self.robust_scaler = joblib.load('model_uk/robust_scaler.joblib')
      
        self.encoders = {
            'Brand': joblib.load('model_uk/Brand_encoder.joblib'),
            'Body type': joblib.load('model_uk/Body type_encoder.joblib'),
            'Gearbox': joblib.load('model_uk/Gearbox_encoder.joblib'),
            'Emission Class': joblib.load('model_uk/Emission Class_encoder.joblib')
        }
