...
class LoanApprovalModel:
    def __init__(self):
        ...
        self.model = joblib.load('model_universal/model.joblib')
        self.scaler = joblib.load('model_universal/scaler.joblib')
        self.feature_names = joblib.load('model_universal/feature_names.joblib')
