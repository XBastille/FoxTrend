...
class UsedCarPricePredictor:
    def __init__(self):
        self.model = joblib.load('model_india/model.joblib')
        self.scaler = joblib.load('model_india/scaler.joblib')
        self.feature_names = joblib.load('model_india/feature_names.joblib')
